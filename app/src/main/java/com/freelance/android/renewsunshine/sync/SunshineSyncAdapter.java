package com.freelance.android.renewsunshine.sync;
...
import com.freelance.android.renewsunshine.BuildConfig;
import com.freelance.android.renewsunshine.R;
import com.freelance.android.renewsunshine.utils.Utility;
import com.freelance.android.renewsunshine.activities.MainActivity;
import com.freelance.android.renewsunshine.data.WeatherContract;
...
//    private final Context mContext;
                ...
                if (cursor.moveToFirst()) {
                    ...
                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(getContext())
                                    .setColor(resources.getColor(R.color.sunshine_light_green))
                                    .setSmallIcon(iconId)
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        com.freelance.android.renewsunshine.sync.SunshineSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
...
*/
   ...
   /* public void getWeatherDataFromJson(String forecastJsonStr, String locationSetting) throws JSONException{
        ...
        try {
            ...
            *//*JSONObject cityJSON = cityJson.getJSONObject(OWM_COORD);
            double cityLatitude = cityJSON.getLong(OWM_COORD_LAT);
            double cityLongitude = cityJSON.getLong(OWM_COORD_LONG);*//*

            JSONObject cityCoord = cityJson.getJSONObject(OWM_COORD);
            double cityLatitude = cityCoord.getLong(OWM_LATITUDE);
            double cityLongitude = cityCoord.getLong(OWM_LONGITUDE);

            // Insert the location into the database.
            long locationId = addLocation(cityName, locationSetting, cityLatitude, cityLongitude);
...
//            long locationID = addLocation(cityName, locationQuery, cityLatitude, cityLongitude);
            ...
            cVVector = new Vector<ContentValues>(c.getCount());
            if (c.moveToFirst()) {
                do {
